...
class TriviaCard extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    ...
    return (<div className={trivia.fullscreen ? 'page fullscreen' : 'page'}>
      ...
      <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnshimiye.github.io%2Fevery-hour%2F%23%2Ftrivia%3Fq%3D${encodeURIComponent(`${trivia.question && trivia.question.content}\nTrue or False `)}`} target="_blank" aria-label="Facebook">
      ...
      <a className="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text="${encodeURIComponent(`${trivia.question && trivia.question.content}\nTrue or False `)}"&amp;url=https%3A%2F%2Fnshimiye.github.io%2Fevery-hour%2F%23%2Ftrivia`} target="_blank" aria-label="Twitter">
      ...
      <a className="resp-sharing-button__link" href={`https://plus.google.com/share?text="${encodeURIComponent(`${trivia.question && trivia.question.content}\nTrue or False `)}"&url=https%3A%2F%2Fnshimiye.github.io%2Fevery-hour%2F%23%2Ftrivia`} target="_blank" aria-label="Google+">
